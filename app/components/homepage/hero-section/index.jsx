...
function HeroSection() {
  return (
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8 items-center">
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Stripe Connect</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Razorpay</span>
                <span className="text-gray-400">{"', '"}</span>
                ...
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">React Testing Library</span>
                <span className="text-gray-400">{"', '"}</span>
